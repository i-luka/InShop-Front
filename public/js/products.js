...
<nav class="navigation">
    ...
    <div class="offer-description-container ">
           <div class="offer-description-product container">
               <div class="offer-description-block-prod">
                 <img src="../img/offer/track.svg" alt="" class="offer-description-block-product-img1 offer-prod-img"> 
                 <div class="offer-description-block-prod-text">
                     <p class="offer-description-block-prod-text-header">
                         Free Delivery
                     </p>
                     <p class="offer-description-block-prod-text-content">
                         Worldwide delivery on all. Authorit tively morph next-generation innov tion with extensive models.
                     </p>
                 </div>
                </div>
                <div class="offer-description-block-prod">
                 <img src="../img/offer/tax.svg" alt="" class="offer-description-block-img2 offer-prod-img"> 
                 <div class="offer-description-block-prod-text">
                     <p class="offer-description-block-prod-text-header">
                         Sales & discounts
                     </p>
                ...
                <div class="offer-description-block-prod">
                 <img src="../img/offer/crown.svg" alt="" class="offer-description-block-img3 offer-prod-img"> 
                 <div class="offer-description-block-prod-text">
                     <p class="offer-description-block-prod-text-header">
                         Quality assurance
                     </p>
...
<div class="subscribe">
    <div class="subscribe-container container header-flex">
        <div class="subscribe-left">
            <figure class="subscripe-left-block header-flex">
                <div class="subscribe-left-img-block">
                    <img src="../img/banner-bottom/face.png" alt="" class="subscribe-left-img">
                </div>
                <div class="subscribe-left-text">
                    <p class="subscribe-left-text-header">
                        “Vestibulum quis porttitor dui! Quisque viverra nunc mi,
                        a pulvinar purus condimentum a. Aliquam condimentum mattis neque sed pretium”
                    </p>
                    <p class="subscribe-left-text-content">
                             <span class="subscribe-left-text-name pink">
                                 Bin Burhan
                             </span>
                        <br>
                        <span class="subscribe-left-text-location">
                            Dhaka, Bd
                             </span>
                    </p>
                </div>
            </figure>
            <div class="subscribe-left-panel header-flex">
                <div class="subscribe-left-panel-item" id=subscribe-left-panel-item1></div>
                <div class="subscribe-left-panel-item" id=subscribe-left-panel-item2></div>
                <div class="subscribe-left-panel-item" id=subscribe-left-panel-item3></div>

            </div>
        </div>
        <div class="subscribe-right">
            <aside class="subscribe-right-block">
                <div class="subscribe-right-block-text">
                    <p class="subscribe-right-block-text-header">
                        Subscribe
                    </p>
                    <p class="subscribe-right-block-text-content">
                        FOR OUR NEWLETTER AND PROMOTION
                    </p>
                </div>
                <form action="#" class="subscribe-right-block-form header-flex">
                    <input type="email" placeholder="Enter Your Email"
                           class="subscribe-right-block-form-input">
                    <button class="subscribe-right-block-form-button
                                        bover-b">
                        Subscribe
                    </button>
                </form>
...
<footer>
    <div class="footer-nav container">
        <div class="footer-nav-left">
            <div class="footer-nav-left-logoblock">
                <img src="../img/logo.png" alt="" class="footer-nav-left-logo">
                <p class="footer-nav-left-logoblock-brand">
                    BRAN<span class="footer-nav-left-logoblock-brand-d pink">D</span>
                </p>
            </div>
            <div class="footer-nav-left-description">
                <p class="">Objectively transition extensive data rather than cross functional solutions. Monotonectally syndicate multidisciplinary materials before go forward benefits. Intrinsicly syndicate an expanded array of processes and cross-unit partnerships.
                </p>
                <p class="">Efficiently plagiarize 24/365 action items and focused infomediaries.
                    Distinctively seize superior initiatives for wireless technologies. Dynamically optimize.
                </p>
            </div>
        </div>
        <div class="footer-nav-right">
            <div class="footer-nav-right-block">
                <p class="pink">
                    COMPANY
                </p>
                <nav>
            ...
            <div class="footer-nav-right-block">
                ...
                <nav>
                    <ul>
                        <li><a href="../pages/product.html">Men</a></li>
                        <li><a href="../pages/product.html">Women</a></li>
                        <li><a href="../pages/product.html">Child</a></li>
                        <li><a href="../pages/product.html">Apparel</a></li>
                        <li><a href="../pages/product.html">Brows All</a></li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <div class="footer-bottom">
        <div class="footer-bottom-container container header-flex">
            <p>
